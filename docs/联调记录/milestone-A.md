...
| 6 | 宿主构建产物只出现一份 Vue | ⏳ 待核一次她的构建产物(09-09 验的是开发态运行,没看产物);我方仓库外最小宿主 2026-09-06 已验单份 Vue。与页面菜单无关,菜单已确认不做 |
...
结论:我方能做的 4 项全部通过;宿主侧的第 2、7 条 2026-09-09 随 T2.6 验收补勾(见上表),**只剩第 6 条**「她的构建产物里只有一份 Vue」待核 —— 这一条与页面菜单无关(菜单 2026-09-10 经业务确认不做)。
